...
from script.actions import FlGuiChannelSelectAction, SequencerPageChangeAttemptedAction, \
    SequencerPageChangedAction
...
class SequencerPageView(View):
    ...
    def __init__(self, action_dispatcher, surface, fl, product_defs, model):
        ...
        num_pages = (FlConstants.MaxStepsPerPattern + self.num_steps_per_page - 1) // self.num_steps_per_page
        self.arrow_button_view = ArrowButtonView(action_dispatcher, surface, product_defs,
