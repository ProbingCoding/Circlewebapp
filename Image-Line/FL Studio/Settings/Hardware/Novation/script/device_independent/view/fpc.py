...
class Fpc(View):
    ...
    def _get_note_for_pad(self, pad):
        ...
        note_number = self.fl.plugin.get_midi_note_for_pad(self.fl.selected_channel(), fpc_pad)
        return note_number

    def _update_colours_for_pads(self):
        for pad in range(Pads.Num.value):
            r, g, b = self._get_colour_for_pad(pad)
            self.colour_for_pad[pad] = r // 2, g // 2, b // 2
    ...
    def _get_colour_for_pad(self, pad):
        ...
        return (max(self.colour_component_min, r),
