...
class ShowGraphEditorView(View):
    ...
    def handle_SequencerStepEditStateChangedAction(self, action):
        if self.model.sequencer.step_edit_state == SequencerStepEditState.EditLatch or \
                self.model.sequencer.step_edit_state == SequencerStepEditState.EditQuick:
            self._show_graph_editor(self.model.sequencer.step_edit_group.get_steps(),
