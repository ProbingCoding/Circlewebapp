from script.actions import SequencerStepEditGroupChangedAction, SequencerStepEditStateChangedAction, \
    SequencerStepPressAction, SequencerStepReleaseAction
from script.commands import ExitStepEditModeCommand
from script.constants import Pads, SequencerStepEditState
from script.device_independent.view import SequencerPadDisplayView, SequencerPlayingStepView, \
    SequencerStepEditStateMachine, SequencerStepToggleView
...
class SequencerViewManager:
    ...
    def __init__(self, action_dispatcher, command_dispatcher, pad_led_writer, fl, product_defs, model):
        ...
        self.sequencer_step_toggle_view = SequencerStepToggleView(action_dispatcher, command_dispatcher, fl,
                                                                  product_defs, model, self.sequencer_pad_display_view)
        self.views = {
    ...
    def handle_SequencerStepEditParameterChangeAttemptedAction(self, action):
        ...
        if self.limit_displayed_parameter_change_rate_timer.finished() \
        ...
        if old_edited != self.model.sequencer.step_edit_group.edited or \
                old_displayed_step_edit_parameter != self.model.sequencer.step_edit_group.displayed_step_edit_parameter:
