...
class FLkeyMiniProductDefs:
    ...
    def IsShiftButton(self, button):
        if button == self.Button.MixerLeftShift or \
                button == self.Button.MixerRightShift or \
                button == self.Button.ChannelRackUpShift or \
                button == self.Button.ChannelRackDownShift or \
                button == self.Button.PresetUpShift or \
                button == self.Button.PresetDownShift:
            return True
        return False
