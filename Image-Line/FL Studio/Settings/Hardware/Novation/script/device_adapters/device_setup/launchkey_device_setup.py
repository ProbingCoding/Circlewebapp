class LaunchkeyDeviceSetup:
    ...
    def _select_pot_layout_pan(self):
        self.sender.send_message(*self.product_defs.SurfaceEvent.PotLayout.value,
                                 self.product_defs.PotLayout.Volume.value)

    def _select_pad_layout_drum(self):
        self.sender.send_message(*self.product_defs.SurfaceEvent.PadLayout.value,
                                 self.product_defs.PadLayout.Drum.value)
    ...
    def _select_fader_layout_volume(self):
        ...
        # a workaround.
        self.sender.send_message(*self.product_defs.SurfaceEvent.FaderLayout.value,
                                 self.product_defs.FaderLayout.SendA.value)
        self.sender.send_message(*self.product_defs.SurfaceEvent.FaderLayout.value,
                                 self.product_defs.FaderLayout.Volume.value)
