...
from script.device_independent.view import ScaleModelController, ShowHighlightsView, TapTempoButtonView, \
    TransportPlayStopButtonView, TransportRecordButtonView
from script.device_dependent.FLkey import ChannelRackPadLayoutManager, CustomPadLayoutManager, \
    InstrumentPadLayoutManager, MixerPanPotLayoutManager, MixerVolumePotLayoutManager, MomentaryPotLayoutManager, \
    PluginPotLayoutManager, SequencerPadLayoutManager
from util.command_dispatcher import CommandDispatcher


class Application:

    def __init__(self, pad_led_writer, button_led_writer, fl, action_dispatcher, screen_writer, device_manager,
                 product_defs):
