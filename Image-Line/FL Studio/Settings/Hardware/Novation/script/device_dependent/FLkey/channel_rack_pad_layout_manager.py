...
class ChannelRackPadLayoutManager:
    def __init__(self, action_dispatcher, pad_led_writer, button_led_writer, screen_writer, fl, product_defs, model,
        ...
        self.channel_selection_independent_view = {
            view.ChannelRackDrumPadsView(action_dispatcher, channel_rack_pad_led_writer, fl, model),
            view.ChannelBankView(action_dispatcher, button_led_writer, fl, product_defs, model),
            view.ChannelBankNamesHighlightView(action_dispatcher, fl, model),
        }
        self.fl = fl
