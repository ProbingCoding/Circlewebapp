...
from script.device_independent.view import ChannelSelectStepsHighlightView, ChannelSelectView, \
    ExitStepEditLatchModeView, PresetButtonScreenView, PresetButtonView, SequencerPageView, SequencerViewManager
from util.mapped_pad_led_writer import MappedPadLedWriter


class SequencerPadLayoutManager:
    def __init__(self, action_dispatcher, command_dispatcher, pad_led_writer, button_led_writer, screen_writer, fl,
                 product_defs, model,
                 device_manager, fl_window_manager):
        ...
        self.channel_selection_dependent_views = {
            ...
            SequencerViewManager(action_dispatcher, command_dispatcher, sequencer_pad_led_writer, fl, product_defs,
                                 model),
        ...
        self.channel_select_view = ChannelSelectView(action_dispatcher, button_led_writer, fl,
                                                     product_defs)
        self.exit_step_edit_latch_mode_view = ExitStepEditLatchModeView(action_dispatcher, command_dispatcher,
                                                                        button_led_writer, product_defs)
