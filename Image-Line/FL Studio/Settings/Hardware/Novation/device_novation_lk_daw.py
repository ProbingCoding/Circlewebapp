...
from script.device_dependent.Launchkey import Application
...
firmware_version_validation_controller = FirmwareVersionValidationController(action_dispatcher, product_defs, fl,
                                                                             sender)
application = Application(led_writer, led_writer, fl, action_dispatcher, screen_writer, product_defs, device_manager)
